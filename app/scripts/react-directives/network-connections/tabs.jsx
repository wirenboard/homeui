...
export const TabList = ({ children }) => {
  return <ul className="col-md-3 col-lg-2 nav nav-pills nav-stacked">{children}</ul>;
};
...
export const TabContent = ({ children }) => {
  return <div className="col-md-9 col-lg-10 tab-content well well-small">{children}</div>;
};
