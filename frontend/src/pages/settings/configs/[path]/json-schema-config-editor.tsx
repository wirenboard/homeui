...
// New json-schema-editor for a confed config, opted into via the schema's `wb-json-editor`
// flag. Changes flow back through the same onChange seam the legacy editor uses.
